 ...
 * @since 2.11.0
 */
export declare const or: <A, C extends A>(second: Refinement<A, C>) => <B extends A>(first: Refinement<A, B>) => Refinement<A, C | B>;
/**
 * @category combinators
 * @since 2.11.0
 */
export declare const and: <A, C extends A>(second: Refinement<A, C>) => <B extends A>(first: Refinement<A, B>) => Refinement<A, B & C>;
/**
 * @category combinators
 * @since 2.11.0
 */
