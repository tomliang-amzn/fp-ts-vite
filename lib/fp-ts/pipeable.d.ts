...
import { Compactable, Compactable1, Compactable2, Compactable2C, Compactable3, Compactable3C, Compactable4, Separated } from './Compactable';
import { Contravariant, Contravariant1, Contravariant2, Contravariant2C, Contravariant3, Contravariant3C, Contravariant4 } from './Contravariant';
...
import { FilterableWithIndex, FilterableWithIndex1, FilterableWithIndex2, FilterableWithIndex2C, FilterableWithIndex3, FilterableWithIndex3C, FilterableWithIndex4, PredicateWithIndex, RefinementWithIndex } from './FilterableWithIndex';
import { Foldable, Foldable1, Foldable2, Foldable2C, Foldable3, Foldable3C, Foldable4 } from './Foldable';
import { FoldableWithIndex, FoldableWithIndex1, FoldableWithIndex2, FoldableWithIndex2C, FoldableWithIndex3, FoldableWithIndex3C, FoldableWithIndex4 } from './FoldableWithIndex';
import { Lazy, pipe as pipeFromFunctionModule, Predicate, Refinement } from './function';
...
import { MonadThrow, MonadThrow1, MonadThrow2, MonadThrow2C, MonadThrow3, MonadThrow3C, MonadThrow4 } from './MonadThrow';
import { Monoid } from './Monoid';
import { Option } from './Option';
import { Profunctor, Profunctor2, Profunctor2C, Profunctor3, Profunctor3C, Profunctor4 } from './Profunctor';
import { Semigroupoid, Semigroupoid2, Semigroupoid2C, Semigroupoid3, Semigroupoid3C, Semigroupoid4 } from './Semigroupoid';
/**
 * @since 2.0.0
 * @deprecated
 */
...
export interface PipeableFilterableWithIndex3<F extends URIS3, I> extends PipeableFilterable3<F> {
    ...
    readonly filterMapWithIndex: <A, B>(f: (i: I, a: A) => Option<B>) => <R, E>(fa: Kind3<F, R, E, A>) => Kind3<F, R, E, A>;
    readonly partitionWithIndex: {
...
export interface PipeableFilterableWithIndex4<F extends URIS4, I> extends PipeableFilterable4<F> {
    ...
    readonly filterMapWithIndex: <A, B>(f: (i: I, a: A) => Option<B>) => <S, R, E>(fa: Kind4<F, S, R, E, A>) => Kind4<F, S, R, E, A>;
    readonly partitionWithIndex: {
...
/** @deprecated */
export declare function pipeable<F extends URIS3, I, E>(I: {
    readonly URI: F;
...
/** @deprecated */
export declare function pipeable<F extends URIS2, I, E>(I: {
    readonly URI: F;
    readonly _E: E;
