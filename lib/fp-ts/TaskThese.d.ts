 ...
 * @since 2.10.0
 */
export declare const match: <E, B, A>(onLeft: (e: E) => B, onRight: (a: A) => B, onBoth: (e: E, a: A) => B) => (fa: TaskThese<E, A>) => Task<B>;
/**
 ...
 * @since 2.10.0
 */
export declare const matchW: <E, B, A, C, D>(onLeft: (e: E) => B, onRight: (a: A) => C, onBoth: (e: E, a: A) => D) => (ma: TaskThese<E, A>) => T.Task<B | C | D>;
/**
 * @category destructors
 * @since 2.10.0
 */
export declare const matchE: <E, B, A>(onLeft: (e: E) => Task<B>, onRight: (a: A) => Task<B>, onBoth: (e: E, a: A) => Task<B>) => (fa: TaskThese<E, A>) => Task<B>;
/**
 ...
 * @since 2.4.0
 */
export declare const fold: <E, B, A>(onLeft: (e: E) => T.Task<B>, onRight: (a: A) => T.Task<B>, onBoth: (e: E, a: A) => T.Task<B>) => (fa: TaskThese<E, A>) => T.Task<B>;
/**
 ...
 * @since 2.10.0
 */
export declare const matchEW: <E, B, A, C, D>(onLeft: (e: E) => Task<B>, onRight: (a: A) => Task<C>, onBoth: (e: E, a: A) => Task<D>) => (fa: TaskThese<E, A>) => Task<B | C | D>;
/**
 ...
 * @since 2.10.0
 */
export declare const foldW: <E, B, A, C, D>(onLeft: (e: E) => T.Task<B>, onRight: (a: A) => T.Task<C>, onBoth: (e: E, a: A) => T.Task<D>) => (fa: TaskThese<E, A>) => T.Task<B | C | D>;
/**
 ...
 * @since 2.10.0
 */
export declare const fromOption: <E>(onNone: Lazy<E>) => import("./NaturalTransformation").NaturalTransformation12C<"Option", "TaskThese", E>;
/**
 * @category combinators
 * @since 2.10.0
 */
export declare const fromOptionK: <E>(onNone: Lazy<E>) => <A extends readonly unknown[], B>(f: (...a: A) => import("./Option").Option<B>) => (...a: A) => TaskThese<E, B>;
/**
 * @category constructors
 * @since 2.10.0
 */
export declare const fromPredicate: {
    <A, B extends A, E>(refinement: import("./Refinement").Refinement<A, B>, onFalse: (a: A) => E): (a: A) => TaskThese<E, B>;
    <A_1, E_1>(predicate: import("./Predicate").Predicate<A_1>, onFalse: (a: A_1) => E_1): <B_1 extends A_1>(b: B_1) => TaskThese<E_1, B_1>;
 ...
 * @since 2.11.0
 */
export declare const fromTheseK: <A extends readonly unknown[], E, B>(f: (...a: A) => TH.These<E, B>) => (...a: A) => TaskThese<E, B>;
/**
 * @category instances
 * @since 2.10.0
 */
 ...
 * @since 2.10.0
 */
export declare const fromIOK: <A extends readonly unknown[], B>(f: (...a: A) => IO<B>) => <E>(...a: A) => TaskThese<E, B>;
/**
 * @category instances
 * @since 2.10.0
 */
 ...
 * @since 2.10.0
 */
export declare const fromTaskK: <A extends readonly unknown[], B>(f: (...a: A) => T.Task<B>) => <E>(...a: A) => TaskThese<E, B>;
/**
 * @since 2.10.0
 */
 ...
 * @since 2.11.0
 */
export declare const traverseReadonlyNonEmptyArrayWithIndex: <E>(S: Semigroup<E>) => <A, B>(f: (index: number, a: A) => TaskThese<E, B>) => (as: ReadonlyNonEmptyArray<A>) => TaskThese<E, ReadonlyNonEmptyArray<B>>;
/**
 * Equivalent to `ReadonlyArray#traverseWithIndex(getApplicative(T.ApplicativePar, S))`.
 *
 * @since 2.11.0
 */
export declare const traverseReadonlyArrayWithIndex: <E>(S: Semigroup<E>) => <A, B>(f: (index: number, a: A) => TaskThese<E, B>) => (as: readonly A[]) => TaskThese<E, readonly B[]>;
/**
 * Equivalent to `ReadonlyNonEmptyArray#traverseWithIndex(getApplicative(T.ApplicativeSeq, S))`.
 *
 * @since 2.11.0
 */
export declare const traverseReadonlyNonEmptyArrayWithIndexSeq: <E>(S: Semigroup<E>) => <A, B>(f: (index: number, a: A) => TaskThese<E, B>) => (as: ReadonlyNonEmptyArray<A>) => TaskThese<E, ReadonlyNonEmptyArray<B>>;
/**
 * Equivalent to `ReadonlyArray#traverseWithIndex(getApplicative(T.ApplicativeSeq, S))`.
 *
 * @since 2.11.0
 */
export declare const traverseReadonlyArrayWithIndexSeq: <E>(S: Semigroup<E>) => <A, B>(f: (index: number, a: A) => TaskThese<E, B>) => (as: readonly A[]) => TaskThese<E, readonly B[]>;
/**
