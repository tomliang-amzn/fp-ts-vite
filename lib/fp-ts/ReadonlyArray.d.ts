 ...
 * @since 2.11.0
 */
export declare const matchW: <B, A, C>(onEmpty: Lazy<B>, onNonEmpty: (as: RNEA.ReadonlyNonEmptyArray<A>) => C) => (as: readonly A[]) => B | C;
/**
 * @category destructors
 * @since 2.11.0
 */
export declare const match: <B, A>(onEmpty: Lazy<B>, onNonEmpty: (as: ReadonlyNonEmptyArray<A>) => B) => (as: ReadonlyArray<A>) => B;
/**
 ...
 * @since 2.11.0
 */
export declare const matchLeftW: <B, A, C>(onEmpty: Lazy<B>, onNonEmpty: (head: A, tail: readonly A[]) => C) => (as: readonly A[]) => B | C;
/**
 ...
 * @since 2.10.0
 */
export declare const matchLeft: <B, A>(onEmpty: Lazy<B>, onNonEmpty: (head: A, tail: ReadonlyArray<A>) => B) => (as: ReadonlyArray<A>) => B;
/**
 ...
 * @since 2.5.0
 */
export declare const foldLeft: <A, B>(onEmpty: Lazy<B>, onNonEmpty: (head: A, tail: ReadonlyArray<A>) => B) => (as: ReadonlyArray<A>) => B;
/**
 ...
 * @since 2.11.0
 */
export declare const matchRightW: <B, A, C>(onEmpty: Lazy<B>, onNonEmpty: (init: readonly A[], last: A) => C) => (as: readonly A[]) => B | C;
/**
 ...
 * @since 2.10.0
 */
export declare const matchRight: <B, A>(onEmpty: Lazy<B>, onNonEmpty: (init: ReadonlyArray<A>, last: A) => B) => (as: ReadonlyArray<A>) => B;
/**
 ...
 * @since 2.5.0
 */
export declare const foldRight: <A, B>(onEmpty: Lazy<B>, onNonEmpty: (init: ReadonlyArray<A>, last: A) => B) => (as: ReadonlyArray<A>) => B;
/**
 ...
 * @since 2.5.0
 */
export declare const scanRight: <A, B>(b: B, f: (a: A, b: B) => B) => (as: readonly A[]) => RNEA.ReadonlyNonEmptyArray<B>;
/**
 ...
 * @since 2.5.0
 */
export declare const chop: <A, B>(f: (as: RNEA.ReadonlyNonEmptyArray<A>) => readonly [B, readonly A[]]) => (as: readonly A[]) => readonly B[];
/**
 ...
 * @since 2.11.0
 */
export declare const fromOptionK: <A extends readonly unknown[], B>(f: (...a: A) => Option<B>) => (...a: A) => readonly B[];
/**
...
/** @internal */
export declare const _chainRecDepthFirst: ChainRec1<URI>['chainRec'];
/** @internal */
export declare const _chainRecBreadthFirst: ChainRec1<URI>['chainRec'];
/**
 * @category Pointed
 * @since 2.5.0
 */
 ...
 * @since 2.5.0
 */
export declare const partitionMap: <A, B, C>(f: (a: A) => Either<B, C>) => (fa: ReadonlyArray<A>) => Separated<ReadonlyArray<B>, ReadonlyArray<C>>;
/**
 * @category FilterableWithIndex
 * @since 2.5.0
 */
export declare const partitionMapWithIndex: <A, B, C>(f: (i: number, a: A) => Either<B, C>) => (fa: readonly A[]) => Separated<readonly B[], readonly C[]>;
/**
 * @category FilterableWithIndex
 * @since 2.5.0
 */
 ...
 * @since 2.11.0
 */
export declare const fromEitherK: <E, A extends readonly unknown[], B>(f: (...a: A) => Either<E, B>) => (...a: A) => readonly B[];
/**
 * @category unsafe
 * @since 2.5.0
 */
 ...
 * @since 2.8.0
 */
export declare const bind: <N extends string, A, B>(name: Exclude<N, keyof A>, f: (a: A) => readonly B[]) => (ma: readonly A[]) => readonly { readonly [K in N | keyof A]: K extends keyof A ? A[K] : B; }[];
/**
 * @since 2.8.0
 */
export declare const apS: <N extends string, A, B>(name: Exclude<N, keyof A>, fb: readonly B[]) => (fa: readonly A[]) => readonly { readonly [K in N | keyof A]: K extends keyof A ? A[K] : B; }[];
/**
 ...
 * @deprecated
 */
export declare const readonlyArray: FunctorWithIndex1<URI, number> & Monad1<URI> & Unfoldable1<URI> & Alternative1<URI> & Extend1<URI> & FilterableWithIndex1<URI, number> & FoldableWithIndex1<URI, number> & TraversableWithIndex1<URI, number> & Witherable1<URI>;
